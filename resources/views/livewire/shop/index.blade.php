    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="form-group">
                <input wire:model="search" type="text" class="form-control" placeholder="Cari Barang">
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12 col-xs-12 col-md-4 col-lg-3 mb-4">
            <div class="card h-80">
                ...
                <div class="card-img-overlay" style="background-color: rgba(0,0,0,0.5);">
                    ...
                    <button wire:click="addToCart({{ $product->id }})" type="button" class="btn btn-sm btn-block btn-outline-secondary text-white">Tambah ke Keranjang</button>
                </div>
            </div>
        </div>
        @endforeach
